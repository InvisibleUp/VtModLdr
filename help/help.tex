...
\begin{tabulary}{\textwidth}{CLLC}
    \mbox{Op}  & Description        & Notes                                    & \mbox{Order} \\ 
    \verb|+|  & Addition & ~                                                                     & 3  \\ 
    \verb|-|  & Subtraction  & ~                                                                  & 3  \\ 
...
%    ~         & ~                                                                            & ~  \\ 
    \textbar  & Bitwise OR. & Integers only.                                 & 7  \\ 
    \&        & Bitwise AND. & Integers only.                                & 7  \\ 
    \^{}      & Bitwise XOR. & Integers only.                                & 7  \\
    \verb|~|  & Bitwise NOT. & Integers only.                                & 1  \\	
    \verb|<<| & Right shift. & Integers only.                                & 4  \\ 
    \verb|>>| & Left shift. & Integers only.                                 & 4  \\ 
%    ~         & ~                                                                            & ~  \\ 
    \verb|==| & Equal. & Gives 0 if true, 1 if false.                                           & 6  \\
    \verb|!=| & Not equal. & Gives 0 if true, 1 if false.                                       & 6  \\ 	
    \verb|<=| & Less than or equal. & Gives 0 if true, 1 if false.                              & 5  \\ 
    \verb|>=| & Greater than or equal. & Gives 0 if true, 1 if false.                           & 5  \\ 
